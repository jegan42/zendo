...
function SellerHome() {
    ...
    async function fetchSellerData() {
        try {
            ...
            // Appel API avec l'instance api
            const response = await api.get(`/seller/${user._id}`);

            // Mise à jour des states avec les données reçues
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="seller-product-info">
                                        <h3 className="seller-product-name">
                                            {product.name}
                                        </h3>
