...
function Favoris() {
    ...
    const [selectedFavoriId, setSelectedFavoriId] = useState<string | null>(
        null
    );
    ...
    useEffect(function () {
        ...
        api.get("/favoris").then(function (response) {
            ...
            Promise.all(variationsPromises).then(function (
        ...
        return favoris.map(function (favori: any) {
            return (
                <div key={favori._id} className="favoris-item">
                    <Link
                        to={"/produit/" + favori._id}
                        className="favoris-link"
                    >
                        <img
                            src={
