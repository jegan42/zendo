...
// !!! JC !!! modification pour vercel : on a déplacé la partie Express dans app.ts
//  pour pouvoir l'importer dans d'autres fichiers (ex: pour les tests) sans démarrer le serveur à chaque fois
// =============================================================
